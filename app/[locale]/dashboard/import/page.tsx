...
import {
  ImportedMosque,
  ImportedMosquesResponse,
} from "@/types/imported-mosques";
...
export default function ImportedMosquesPage() {
  ...
  const [selectedMosque, setSelectedMosque] = useState<ImportedMosque | null>(
    null
  );
  ...
  const [mosqueToDelete, setMosqueToDelete] = useState<ImportedMosque | null>(
    null
  );
  ...
  return (
    <div className="min-h-screen">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                ...
                <span className="font-bold text-blue-600">
                  {isLoading
                    ? "..."
                    : importedMosques.filter((m) => m.is_reconstruction === 1)
                        .length}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-amber-50 rounded-lg">
                ...
                <span className="font-bold text-amber-600">
                  {isLoading
                    ? "..."
                    : importedMosques.filter((m) => m.is_reconstruction === 0)
                        .length}
                </span>
              </div>
                  ...
                  <span className="font-bold text-slate-900">
                    {isLoading
                      ...
                      : new Intl.NumberFormat("ar-SY", {
                          ...
                          importedMosques.reduce(
                            (sum, m) => sum + parseFloat(m.estimated_cost),
                            0
                          )
                        )}
                  </span>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold text-slate-600 mb-2">
                  لا توجد مساجد مستوردة
                </h3>
                <p className="text-slate-500">
                  قم برفع ملف Excel لاستيراد بيانات المساجد
                </p>
              </div>
            ) : (
                        ...
                        <TableCell>
                          <div>
                            ...
                            <div className="text-xs text-slate-500">
                              ID: {mosque.id} | Batch: {mosque.batch_id}
                            </div>
                          </div>
                        </TableCell>
                        <TableCell>
                          <div className="text-sm">
                            ...
                            <div className="text-slate-600">
                              {mosque.district} - {mosque.sub_district}
                            </div>
            ...
            <div className="grid md:grid-cols-1 lg:grid-cols-1 gap-4">
              <div className="p-4 border border-slate-200 rounded-lg hover:border-emerald-300 hover:bg-emerald-50 transition-colors">
                ...
                <div className="text-xs text-slate-500 mb-3">
                  يحتوي على: الاسم، الموقع، مستوى الضرر، التكلفة، نوع المشروع،
                  اللجنة، الملاحظات
                </div>
                <Button
                  variant="outline"
      ...
      <MosqueDetailsDialog
        ...
        isTransferring={
          selectedMosque ? isTransferring[selectedMosque.id] || false : false
        }
      />
      ...
      <DeleteConfirmationDialog
        ...
        isLoading={
          mosqueToDelete ? isDeleting[mosqueToDelete.id] || false : false
        }
