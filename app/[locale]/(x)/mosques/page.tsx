...
export default function MosquesPage() {
  ...
  const loadMosques = async (page: number = 1) => {
    try {
      ...
      if (filters.damage_level && filters.damage_level !== "all") {
        if (
          filters.damage_level === "جزئي" ||
          filters.damage_level === "كامل"
        ) {
      ...
      const response = await PublicMosqueService.getPublicMosques({
        ...
        governorate_id: filters.governorate_id
          ? parseInt(filters.governorate_id)
          : undefined,
        district_id: filters.district_id
          ? parseInt(filters.district_id)
          : undefined,
        sub_district_id: filters.sub_district_id
          ? parseInt(filters.sub_district_id)
          : undefined,
        neighborhood_id: filters.neighborhood_id
          ? parseInt(filters.neighborhood_id)
          : undefined,
  ...
  const getMainImage = (mosque: Mosque) => {
    ...
    const mainMedia = mosque.media.find(
      (m) => m.is_main && m.media_stage === "after"
    );
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
          <form onSubmit={handleSearch} className="space-y-4">
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <Button
                type="submit"
                className="lg:w-auto bg-emerald-600 hover:bg-emerald-700"
              >
                بحث
              </Button>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <SubDistrictSelect
                      ...
                      onValueChange={(value) =>
                        handleFilterChange("sub_district_id", value)
                      }
                      parentId={
                        filters.district_id
                          ? parseInt(filters.district_id)
                  ...
                  <div className="space-y-2">
                    ...
                    <NeighborhoodSelect
                      ...
                      onValueChange={(value) =>
                        handleFilterChange("neighborhood_id", value)
                      }
                      parentId={
                  ...
                  <div className="space-y-2">
                    ...
                    <DamageSelect
                      ...
                      onValueChange={(value) =>
                        handleFilterChange("damage_level", value)
                      }
                  ...
                  <div className="space-y-2">
                    ...
                    <SearchableSelect
                      value={
                        filters.is_reconstruction === undefined
                          ? "all"
                          : filters.is_reconstruction
                          ? "reconstruction"
                          : "reconstruction"
                      }
                      onValueChange={(value) => {
                        ...
                        handleFilterChange("is_reconstruction", boolValue);
                      }}
                      options={[
                        { value: "all", label: "جميع الأنواع" },
                        { value: "restoration", label: "ترميم" },
                        { value: "reconstruction", label: "إعادة إعمار" },
                      ]}
        ...
        {!loading && (
          <>
                  ...
                  <div className="relative h-48">
                    ...
                    <div className="absolute top-3 left-3">
                      <Badge variant="outline" className="bg-white/90">
                        {mosque.is_reconstruction == 1
                          ? t("mosques.reconstruction")
                          : t("mosques.restoration")}
                      </Badge>
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center text-slate-600 text-sm">
                        ...
                        <span className="line-clamp-1">
                          {mosque[`governorate_${locale}`]} - {mosque[`district_${locale}`]}
                        </span>
                      </div>
            ...
            <div className="text-center mt-6 text-slate-600 text-sm">
              عرض {(currentPage - 1) * filters.per_page + 1} إلى{" "}
              {Math.min(currentPage * filters.per_page, total)} من أصل {total}{" "}
              مسجد
            </div>
          </>
        )}
