...
export const mockMosques: Mosque[] = [
  {
    ...
    description: "مسجد تاريخي يقع في قلب مدينة حمص، يُعتبر من أهم المعالم الدينية في المنطقة. تعرض المسجد لأضرار جسيمة خلال الأحداث وهو بحاجة ماسة لأعمال إعادة إعمار شاملة للحفاظ على مساجده المعماري الأصيل.",
    latitude: 34.7298,
    longitude: 36.7075,
    damage_level: "كامل",
  ...
  },
  {
    ...
    description: "أحد أهم وأقدم المساجد في العالم الإسلامي، يقع في البلدة القديمة بدمشق. يتميز بعمارته الأموية الفريدة وفسيفسائه التاريخية. يحتاج إلى أعمال ترميم دقيقة للحفاظ على مساجده المعماري النفيس.",
    latitude: 33.5138,
    longitude: 36.3061,
    damage_level: "جزئي",
...
export const mockProjects: Project[] = [
  ...
  },
  {
    ...
    created_at: "2024-01-01T00:00:00Z",
    updated_at: "2024-01-01T00:00:00Z",
    description: "أعمال ترميم دقيقة للحفاظ على المساجد المعماري للمسجد الأموي الكبير",
  },
  {
    id: 3,
